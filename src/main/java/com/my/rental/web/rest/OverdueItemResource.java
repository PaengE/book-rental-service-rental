...
/**
 * REST controller for managing {@link com.my.rental.domain.OverdueItem}.
 */
@RestController
@RequestMapping("/api")
public class OverdueItemResource {
    ...
    public OverdueItemResource(
        OverdueItemService overdueItemService,
        OverdueItemMapper overdueItemMapper,
        OverdueItemRepository overdueItemRepository
    ) {
    ...
    public ResponseEntity<OverdueItemDTO> createOverdueItem(@RequestBody OverdueItemDTO overdueItemDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/overdue-items/" + result.getId()))
    ...
    public ResponseEntity<OverdueItemDTO> updateOverdueItem(
        ...
        @RequestBody OverdueItemDTO overdueItemDTO
    ) throws URISyntaxException {
        log.debug("REST request to update OverdueItem : {}", overdueItemDTO);
        if (overdueItemDTO.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(id, overdueItemDTO.getId())) {
            throw new BadRequestAlertException("Invalid ID", ENTITY_NAME, "idinvalid");
        }

        if (!overdueItemRepository.existsById(id)) {
